...
function add() {
    ...
    todos.push(task);
    /* This conversts the task input to a JSON string*/
...
function show() {
    /*This sests the task that was tretrieved as a variable */
    var todos = get_todos();
...
/*This ill keep the inputs displayed permanently on the screen */
show();
