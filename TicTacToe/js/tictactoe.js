...
function placeXOrO (squareNumber) {
    //This condition ensures a square hasn't been selected already. The .some() method is used to check each element of the selectedSquares 
    // array to see if it contains the squareNumber clicked on.
...
//This function parses the selectedZSquares array to search for win conditions.
...
function checkWinConditions() {
    ...
    //This condition will check for a tie. If none of the above conditions are met and 9 squares are selected the code executes.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (y < y2) { y += 10; }
            //This condition is simliar to the one above. This is necessary for the 6, 4, 2 win conditions.
        ...
        if (x1 <= x2 && y1 >= y2) {
            //This condition adds 10 to the previous end x endpoint.
            if (x < x2) { x += 10; }
            //This condition minus 10 to the previous end y endpoint.
            if (y > y2) { y -= 10; }
            //This condition is simliar to the one above. This is necessary for the 6, 4, 2 win conditions.
            if (x >= x2 && y <= y2) { cancelAnimationFrame(animationLoop); }
        }
    ...
    animateLineDrawing();
    //This line waits 1 second. Then, celars canvas, resets game, an allows clicking again.
